...
def update() :# Nfit = 30 = output
    ...
    for i in range(0 , n) : # Spread out points
        ...
        funct1.plot( pos =(.99 * x[ i ],0.99*y[i]))
    ...
    for i in range(1 , Nfit + 2) : # Begin f i t
